...
def send_simple_message(to, subject, body):
    return requests.post(
        "https://api.mailgun.net/v3/sandboxec3dcec35bbf462298079b8ff555381f.mailgun.org/messages",
        auth=("api", "010a29596b9c0627163cfc1742e81ceb-c9270c97-50344426"),
        data={"from": "Mailgun Sandbox <postmaster@sandboxec3dcec35bbf462298079b8ff555381f.mailgun.org>",
              "to": to,
              "subject": subject,
              "html": body})
